    ...
    >
      ...
      <div className="text-left">
        ...
        <p className="text-base text-justify md:text-lg text-slate-700 my-4 md:my-6">
          ...
          meal, your contribution can make an invaluable difference. By donating
          a small portion of your income, you can provide much-needed food to
          those living on the streets, ensuring they don't have to face another
          day hungry. Your kindness can be life-changing. As a gesture of our
          appreciation, we will send you a photo of the person you helped.
          Together, we can work toward ending hunger and bringing hope to those
          in need. Join us in this mission to ensure that no one has to endure
