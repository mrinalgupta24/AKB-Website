  ...
  return (
    <div className="relative">
      <section>
        ...
        <div className="relative w-full max-w-6xl px-6 lg:px-12 py-8 mt-8 mx-auto">
          <div className="flex flex-col gap-8 sm:gap-20 lg:flex-row-reverse lg:items-center lg:justify-center">
            <div className="flex flex-col items-start text-left">
              <h2 className="mb-6 max-w-4xl mx-auto text-2xl font-bold text-center md:text-4xl">
                The Secret to Our Low Cost Missions
              </h2>
              <p className="mb-2 text-sm text-gray-600 text-justify sm:text-base md:mb-6 lg:mb-8">
              ...
              <p className="mt-2 text-sm text-gray-600 text-justify sm:text-base md:mt-6">
