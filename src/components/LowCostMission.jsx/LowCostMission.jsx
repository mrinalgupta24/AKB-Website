        ...
        <div className="w-full max-w-6xl px-12 py-8 mt-12 mx-auto">
          <div className="flex flex-col gap-8 sm:gap-20 lg:flex-row-reverse lg:items-center lg:justify-center">
            <div className="flex flex-col items-start text-left">
              ...
              <p className="mb-2 text-sm text-gray-500 sm:text-base md:mb-6 lg:mb-8">
              ...
              <ol className="flex flex-col">
                <li className="mb-2 flex items-center">
                  <p className="text-gray-500 text-sm sm:text-base">
                    <strong>1. Direct Sourcing:</strong> We
              ...
              <p className="mt-2 text-sm text-gray-500 sm:text-base md:mt-6">
